 ...
 * @param <T>
 */
public interface ADTListInterface<T> extends Iterable<T>{
     ...
     * new entry
     * @param newEntry the object to be added as a new entry
     * @return true if the addition is successful, or false if newPosition < 1,
     ...
     * desired entry
     * @return a reference to the indicated entry or null, if either 312 CHAPTER
     * 12 Lists ￼￼￼ the list is empty, givenPosition < 1, or givenPosition >
     * getLength()
     */
